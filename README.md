...
![Init and First Commit](screenshot/init-first-commit.png)

### Second and Third Commits
![Second and Third Commit](screenshot/second-third-commit.png)

### Feature Branch Creation and Commit
![Feature Branch Commit](screenshot/feature-branch-commit.png)

### Experiment Branch Commit
![Experiment Branch Commit](screenshot/experiment-branch-commit.png)

### Merge Feature and Test Branch into Main
![Merge Feature and Test](screenshot/merge-feature-test.png)

### Merge Conflict Creation
![Merge Conflict Created](screenshot/merge-conflict-created.png)

### Conflict Resolution and Commit History
![Conflict Resolved](screenshot/conflict-resolved-log.png)
